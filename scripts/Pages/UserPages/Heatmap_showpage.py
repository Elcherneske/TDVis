...
class Heatmap():
    ...
    def show_page(self):
        ...
        if self._load_data():
            ...
            self._plot_visualizations(integrated_data)
    ...
    def _setup_controls(self):
        ...
        with st.sidebar:
            ...
            self.time_range = st.number_input(
                "积分起始时间 (min)",
                min_value=time_min,
                max_value=time_max,
                value=time_min
            ...
            self.mass_range = st.number_input(
                "积分最小质量 (Da)",
                min_value=mass_min,
                max_value=mass_max,
                value=mass_min,
    ...
    def _plot_visualizations(self, data):
        """可视化组件"""
        if data is None:
            return
    ...
    def _plot_spectrum(self, data):
        ...
        fig = px.bar(
            ...
            labels={'Mass': 'm/z', 'y': self._get_scale_label()},
            title='积分质谱图',
